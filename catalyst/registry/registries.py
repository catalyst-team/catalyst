...
def _transforms_loader(r: Registry):
    ...
    from catalyst.contrib.data.cv import torch as t
    ...
    try:
        ...
        from catalyst.contrib.data.cv import albumentations as t
    ...
    try:
        ...
        from catalyst.contrib.data.cv import kornia as t
