...
#     """
#     Logger callback, translates ``runner.*_metrics`` to the telegram channel.
#     """
#
#     def __init__(
#         self,
...
#             text = f"{runner.stage_key} stage was started"
#
...
#             text = f"{runner.loader_key} {runner.global_epoch_step} epoch has started"
#
#             self._send_text(text)
#
...
#
#             rows: List[str] = [
#                 f"{runner.loader_key} {runner.global_epoch_step}" f" epoch was finished:"
#             ]
#
...
#             text = f"{runner.stage_key} stage was finished"
#
#             self._send_text(text)
#
