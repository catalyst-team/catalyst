...
from catalyst.metrics.functional.avg_precision import (
    avg_precision,
    mean_avg_precision,
)
from catalyst.metrics.functional.cmc_score import cmc_score, cmc_score_count
from catalyst.metrics.functional.dice import dice, calculate_dice
...
from catalyst.metrics.functional.precision import average_precision, precision
